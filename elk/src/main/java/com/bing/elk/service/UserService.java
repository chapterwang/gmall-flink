package com.bing.elk.service;

import com.alibaba.fastjson.JSON;
import com.bing.elk.constant.Constant;
import com.bing.elk.document.UserDocument;
import com.bing.elk.dto.UserCityDTO;
...
public class UserService {
    ...
    public Boolean createUserDocument(UserDocument document) throws Exception {
        ...
        pool.sadd("test1",document.toString());
